...
- Реалізуйте функцію розбиття (partition) з вибором останнього елемента як опорного.
...
> **Порада:** Вибір опорного елемента впливає на продуктивність. У наведеному прикладі використовується останній елемент, але можна експериментувати з іншими стратегіями (медіана трьох, випадковий елемент).
...
> **Порада:** Insertion sort ефективний для невеликих масивів (до 10-20 елементів) або коли дані вже майже відсортовані. Він використовується в гібридних алгоритмах (наприклад, Timsort) для обробки малих підмасивів.
...
### Мета
Реалізувати функцію для перевірки збалансованості дужок `()` у рядку з використанням стека. Навчитись використовувати структуру даних stack для розв'язання практичних задач.
