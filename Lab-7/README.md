...
### Мета
Реалізувати програму для підрахунку частоти появи кожного слова у тексті, використовуючи `unordered_map`. Навчитись ефективно працювати з хеш-таблицями для агрегації даних.
